...
public class FXMLDocumentController implements Initializable, Observer {
    ...
    public void setUser(String userString) {
        ...
        try {
            user = userString;
            filename = user + ".txt";
            filePath = "C:\\Users\\silve\\Downloads\\Posta (3)\\Posta\\" + filename;
    ...
    public void visualizeEmail() {
        ...
        try {
            ...
            forwardButton.setOnAction(((event) -> {
                ...
                window.close();
                forward(selectedEmails.get(0).getTesto().replace("|", ""));
            ...
            inviaButton.setOnAction((event) -> {
                try {
                    try {
                        ...
                        Email toSendEmail = new Email(idEmail, LocalDateTime.now(), user, arrayDestinatariString, oggettoField.getText().replace("|", ""), emailTextArea.getText().replace("|", ""));
                        ...
                        AlertMessage("Errore di connessione", "Non sei connesso, riprova dopo");
                    }
        ...
        if (selectedEmails.size() > 0) {
            ...
            try {
                try {
                    ...
                    AlertMessage("Errore di connessione", "Per favore riprova più tardi");
                }
            ...
            alert.setContentText("You must select something to delete first!");
    ...
    public void UpdateEmailGUI() {
        try {
            try {
                ...
                AlertMessage("Errore di connessione", "Non sei connesso al server, riprova più tardi!");
            ...
            try {
                ...
                try {
                    ...
                    emailList.addAll(emails);
                       ...
                       cicle=false;
                        //Thread.currentThread().interrupt(); // interrompo l'updatrer se non c' connessione
