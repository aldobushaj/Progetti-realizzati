...
public class TicTacToeState implements Cloneable {
	...
	@Override
	public aima.core.environment.tictactoe.TicTacToeState clone() {
		aima.core.environment.tictactoe.TicTacToeState copy = null;
		try {
			copy = (aima.core.environment.tictactoe.TicTacToeState) super.clone();
	...
	public boolean equals(Object anObj) {
		if (anObj != null && anObj.getClass() == getClass()) {
			aima.core.environment.tictactoe.TicTacToeState anotherState = (aima.core.environment.tictactoe.TicTacToeState) anObj;
			for (int i = 0; i < 9; i++) {
