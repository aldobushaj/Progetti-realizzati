...
public class VacuumEnvironmentState implements EnvironmentState, Cloneable {
	...
	public boolean equals(Object obj) {
		if (obj != null && getClass() == obj.getClass()) {
			aima.core.environment.vacuum.VacuumEnvironmentState s = (aima.core.environment.vacuum.VacuumEnvironmentState) obj;
	...
	@Override
	public aima.core.environment.vacuum.VacuumEnvironmentState clone() {
		aima.core.environment.vacuum.VacuumEnvironmentState result = null;
		try {
			result = (aima.core.environment.vacuum.VacuumEnvironmentState) super.clone();
