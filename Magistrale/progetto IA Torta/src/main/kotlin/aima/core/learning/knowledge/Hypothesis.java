...
public class Hypothesis {
    ...
    public List<aima.core.learning.knowledge.Hypothesis> specialisations(List<LogicalExample> examplesSoFar) {
        List<aima.core.learning.knowledge.Hypothesis> result = new ArrayList<>();
        ...
        for (String key :
            ...
            aima.core.learning.knowledge.Hypothesis newHypo = new aima.core.learning.knowledge.Hypothesis(this.getGoal(), new ArrayList<>(tempDisjuncts));
            result.add(newHypo);
        }
    ...
    public List<aima.core.learning.knowledge.Hypothesis> generalisations(List<LogicalExample> examplesSoFar) {
        List<aima.core.learning.knowledge.Hypothesis> result = new ArrayList<>();
        LogicalExample lastExample = examplesSoFar.get(examplesSoFar.size() - 1);
        for (List<String> possibledisjunct :
            ...
            if (temp) {
                ...
                aima.core.learning.knowledge.Hypothesis toAdd = new aima.core.learning.knowledge.Hypothesis(this.goal, new ArrayList<>(this.getHypothesis()));
