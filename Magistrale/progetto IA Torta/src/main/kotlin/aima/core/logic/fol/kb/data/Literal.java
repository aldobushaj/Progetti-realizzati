...
public class Literal {
	...
	public aima.core.logic.fol.kb.data.Literal newInstance(AtomicSentence atom) {
		return new aima.core.logic.fol.kb.data.Literal(atom, negativeLiteral);
	}
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof aima.core.logic.fol.kb.data.Literal)) {
			return false;
		}
		aima.core.logic.fol.kb.data.Literal l = (aima.core.logic.fol.kb.data.Literal) o;
	...
	public aima.core.logic.fol.kb.data.Literal substitute(List<Constant> constants){
		...
		return new aima.core.logic.fol.kb.data.Literal(new Predicate(this.getAtomicSentence().getSymbolicName(),toAdd),this.isNegativeLiteral());
	}
}
