...
public interface Node {
	 ...
	 * 
	 * @see aima.core.probability.bayes.Node#getParents()
	 */
	boolean isRoot();
	 ...
	 */
	Set<aima.core.probability.bayes.Node> getParents();

	/**
	 * 
	 * @return the children Nodes for this Node.
	 */
	Set<aima.core.probability.bayes.Node> getChildren();
	 ...
	 */
	Set<aima.core.probability.bayes.Node> getMarkovBlanket();
