...
public abstract class AbstractFiniteDomain implements FiniteDomain, Serializable {
	...
	public int getOffset(Object value) {
		...
		if (null == idx) {
			throw new IllegalArgumentException("Value [" + value
					+ "] is not a possible value of this domain."+this.getPossibleValues()+ "Value is "+value.toString());
		}
		return idx.intValue();
	}
