...
public class ProbUtil {
	...
	public static int expectedSizeOfProbabilityTableMSeparation(List<RandomVariable> evidence, RandomVariable... vars) {
		// initially 1, as this will represent constant assignments
		// e.g. Dice1 = 1.
		int expectedSizeOfDistribution = 1;
		if (null != vars) {
	...
	public static int[] indexesOfValue(RandomVariable[] X, int idx,
		...
		int csize = aima.core.probability.util.ProbUtil.expectedSizeOfCategoricalDistribution(X);
