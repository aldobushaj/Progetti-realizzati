 ...
 *
 */
public class Angle implements IMclVector, Comparable<aima.core.robotics.impl.datatypes.Angle> {
	
	/**
	 * The zero angle represents {@code 0.0} radians.
	 */
	public static final aima.core.robotics.impl.datatypes.Angle ZERO_ANGLE = new aima.core.robotics.impl.datatypes.Angle(0.0d);
	 ...
	 */
	public static aima.core.robotics.impl.datatypes.Angle degreeAngle(double value) {
		return new aima.core.robotics.impl.datatypes.Angle(Math.toRadians(value));
	}
	...
	@Override
	public int compareTo(aima.core.robotics.impl.datatypes.Angle o) {
