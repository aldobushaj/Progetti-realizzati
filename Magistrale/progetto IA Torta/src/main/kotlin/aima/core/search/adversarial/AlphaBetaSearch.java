...
public class AlphaBetaSearch<S, A, P> implements AdversarialSearch<S, A> {
     ...
     */
    public static <STATE, ACTION, PLAYER> aima.core.search.adversarial.AlphaBetaSearch<STATE, ACTION, PLAYER> createFor(
            Game<STATE, ACTION, PLAYER> game) {
        return new aima.core.search.adversarial.AlphaBetaSearch<STATE, ACTION, PLAYER>(game);
    }
