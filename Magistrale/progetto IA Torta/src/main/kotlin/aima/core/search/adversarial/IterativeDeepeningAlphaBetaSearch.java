...
public class IterativeDeepeningAlphaBetaSearch<S, A, P> implements AdversarialSearch<S, A> {
     ...
     */
    public static <STATE, ACTION, PLAYER> aima.core.search.adversarial.IterativeDeepeningAlphaBetaSearch<STATE, ACTION, PLAYER> createFor(
            Game<STATE, ACTION, PLAYER> game, double utilMin, double utilMax, int time) {
        return new aima.core.search.adversarial.IterativeDeepeningAlphaBetaSearch<>(game, utilMin, utilMax, time);
    }
