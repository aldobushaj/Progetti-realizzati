...
public class MinimaxSearch<S, A, P> implements AdversarialSearch<S, A> {
	 ...
	 */
	public static <S, A, P> aima.core.search.adversarial.MinimaxSearch<S, A, P> createFor(Game<S, A, P> game) {
		return new aima.core.search.adversarial.MinimaxSearch<>(game);
	}
