...
public class Assignment<VAR extends Variable, VAL> implements Cloneable {
    ...
    @Override
    public aima.core.search.csp.Assignment<VAR, VAL> clone() {
        aima.core.search.csp.Assignment<VAR, VAL> result;
        try {
            result = (aima.core.search.csp.Assignment<VAR, VAL>) super.clone();
