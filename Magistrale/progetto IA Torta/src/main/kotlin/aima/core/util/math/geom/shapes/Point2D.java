...
public class Point2D implements Cloneable {
	 ...
	 */
	public double distance(aima.core.util.math.geom.shapes.Point2D pt) {
	 ...
	 */
	public aima.core.util.math.geom.shapes.Point2D add(Vector2D op2) {
		return new aima.core.util.math.geom.shapes.Point2D(this.x + op2.getX(), this.y + op2.getY());
	}
	 ...
	 * @return the moved point.
	 */
	public aima.core.util.math.geom.shapes.Point2D sub(Vector2D op2) {
		return new aima.core.util.math.geom.shapes.Point2D(this.x - op2.getX(), this.y - op2.getY());
	}
	 ...
	 */
	public Vector2D vec(aima.core.util.math.geom.shapes.Point2D target) {
	 ...
	 */
	public boolean equals(aima.core.util.math.geom.shapes.Point2D op2) {
	...
	@Override
	 public boolean equals(Object o) {
		 if(o instanceof aima.core.util.math.geom.shapes.Point2D)
			 return this.equals((aima.core.util.math.geom.shapes.Point2D) o);
		 return false;
	 }
	
	@Override
	public aima.core.util.math.geom.shapes.Point2D clone() {
		return new aima.core.util.math.geom.shapes.Point2D(this.x,this.y);
	}
}
