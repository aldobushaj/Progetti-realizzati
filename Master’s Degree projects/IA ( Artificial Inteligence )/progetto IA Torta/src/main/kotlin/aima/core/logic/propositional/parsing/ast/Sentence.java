...
public abstract class Sentence implements ParseTreeNode {
	 ...
	 */
	public aima.core.logic.propositional.parsing.ast.Sentence getSimplerSentence(int offset) {
		return null;
	}
	...
	public String bracketSentenceIfNecessary(Connective parentConnective,
			aima.core.logic.propositional.parsing.ast.Sentence childSentence) {
		String result = null;
	 ...
	 */
	public static aima.core.logic.propositional.parsing.ast.Sentence newDisjunction(aima.core.logic.propositional.parsing.ast.Sentence... disjuncts) {
	 ...
	 * @return a disjunction of the given disjuncts.
	 */
	public static aima.core.logic.propositional.parsing.ast.Sentence newDisjunction(List<? extends aima.core.logic.propositional.parsing.ast.Sentence> disjuncts) {
		if (disjuncts.size() == 0) {
	 ...
	 */
	public static aima.core.logic.propositional.parsing.ast.Sentence newConjunction(aima.core.logic.propositional.parsing.ast.Sentence... conjuncts) {
	 ...
	 * @return a conjunction of the given conjuncts.
	 */
	public static aima.core.logic.propositional.parsing.ast.Sentence newConjunction(List<? extends aima.core.logic.propositional.parsing.ast.Sentence> conjuncts) {
		if (conjuncts.size() == 0) {
