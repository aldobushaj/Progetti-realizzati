...
public interface Factor {
	 ...
	 * Factor.
	 * 
	 * @see aima.core.probability.Factor#iterateOver(Iterator)
	 * @see aima.core.probability.Factor#iterateOver(Iterator, AssignmentProposition...)
	 */
	 ...
	 */
	aima.core.probability.Factor sumOut(RandomVariable... vars);
	 ...
	 *
	 * @see aima.core.probability.Factor#pointwiseProductPOS(aima.core.probability.Factor, RandomVariable...)
	 */
	aima.core.probability.Factor pointwiseProduct(aima.core.probability.Factor multiplier);
	 ...
	 * 
	 * @see aima.core.probability.Factor#pointwiseProduct(aima.core.probability.Factor)
	 */
	aima.core.probability.Factor pointwiseProductPOS(aima.core.probability.Factor multiplier,
