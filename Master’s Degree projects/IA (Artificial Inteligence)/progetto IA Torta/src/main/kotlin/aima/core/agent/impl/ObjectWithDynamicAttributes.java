...
public abstract class ObjectWithDynamicAttributes implements Cloneable {
	 ...
	 */
	public aima.core.agent.impl.ObjectWithDynamicAttributes clone() {
		try {
			aima.core.agent.impl.ObjectWithDynamicAttributes result;
			result = (aima.core.agent.impl.ObjectWithDynamicAttributes) super.clone();
	...
	public boolean equals(Object o) {
		return o != null && getClass() == o.getClass()
			&& attributes.equals(((aima.core.agent.impl.ObjectWithDynamicAttributes) o).attributes);
	}
