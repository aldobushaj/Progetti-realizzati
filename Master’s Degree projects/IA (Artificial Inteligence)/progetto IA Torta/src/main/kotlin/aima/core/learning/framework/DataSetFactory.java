...
public class DataSetFactory {
	...
	public static DataSet getRestaurantDataSet() throws Exception {
		...
		return new aima.core.learning.framework.DataSetFactory().fromFile("restaurant", spec, "\\s+");
	}
	...
	public static DataSet getIrisDataSet() throws Exception {
		...
		return new aima.core.learning.framework.DataSetFactory().fromFile("iris", spec, ",");
	}
