...
public class QuantifiedSentence implements Sentence {
	...
	public aima.core.logic.fol.parsing.ast.QuantifiedSentence copy() {
		List<Variable> copyVars = new ArrayList<Variable>();
		for (Variable v : variables) {
			copyVars.add(v.copy());
		}
		return new aima.core.logic.fol.parsing.ast.QuantifiedSentence(quantifier, copyVars, quantified.copy());
	}
	...
	public boolean equals(Object o) {
		...
		aima.core.logic.fol.parsing.ast.QuantifiedSentence cs = (aima.core.logic.fol.parsing.ast.QuantifiedSentence) o;
