...
public class TransformMatrix2D {
	 ...
	 * <code>[ 0 0 1 ]</code><br/>
	 */
	public static final aima.core.util.math.geom.shapes.TransformMatrix2D UNITY_MATRIX = new aima.core.util.math.geom.shapes.TransformMatrix2D(1.0d,0.0d,0.0d,1.0d,0.0d,0.0d);
	 ...
	 */
	public static aima.core.util.math.geom.shapes.TransformMatrix2D translate(double x, double y) {
		return new aima.core.util.math.geom.shapes.TransformMatrix2D(1.0d,0.0d,0.0d,1.0d,x,y);
	}
	 ...
	 * @return the new transform matrix.
	 */
	public static aima.core.util.math.geom.shapes.TransformMatrix2D scale(double x, double y) {
		return new aima.core.util.math.geom.shapes.TransformMatrix2D(x,0.0d,0.0d,y,0.0d,0.0d);
	}
	 ...
	 * @return the new transform matrix.
	 */
	public static aima.core.util.math.geom.shapes.TransformMatrix2D rotate(double alpha) {
		final double sin = Math.sin(alpha);
		final double cos = Math.cos(alpha);
		return new aima.core.util.math.geom.shapes.TransformMatrix2D(cos,sin,-sin,cos,0.0d,0.0d);
	}
	 ...
	 * @return The new transform matrix.
	 */
	public aima.core.util.math.geom.shapes.TransformMatrix2D multiply(aima.core.util.math.geom.shapes.TransformMatrix2D matrix) {
		return new aima.core.util.math.geom.shapes.TransformMatrix2D(a*matrix.a+c*matrix.b,b*matrix.a+d*matrix.b,a*matrix.c+c*matrix.d,b*matrix.c+d*matrix.d,a*matrix.e+c*matrix.f+e,b*matrix.e+d*matrix.f+f);
	}
	 ...
	 * @return The new transform matrix.
	 */
	public aima.core.util.math.geom.shapes.TransformMatrix2D inverse() {
		if(this == UNITY_MATRIX) return UNITY_MATRIX;
		final double determinant = determinant();
		if(determinant == 0.0d) return null;
		return new aima.core.util.math.geom.shapes.TransformMatrix2D(d/determinant,-b/determinant,-c/determinant,a/determinant,(c*f-d*e)/determinant,(b*e-a*f)/determinant);
	}
	 ...
	 * 
	 * @param op2 the {@link aima.core.util.math.geom.shapes.TransformMatrix2D} to be compared to this matrix.
	 * @return true if both matrices are identical.
	 */
	public boolean equals(aima.core.util.math.geom.shapes.TransformMatrix2D op2) {
	...
	public boolean equals(Object o) {
		if(o instanceof aima.core.util.math.geom.shapes.TransformMatrix2D)
			return this.equals((aima.core.util.math.geom.shapes.TransformMatrix2D) o);
		return false;
	}
}
