...
public class Chain {
	 ...
	 */
	public List<aima.core.logic.fol.kb.data.Chain> getContrapositives() {
		List<aima.core.logic.fol.kb.data.Chain> contrapositives = new ArrayList<aima.core.logic.fol.kb.data.Chain>();
		...
		for (int i = 1; i < literals.size(); i++) {
			...
			aima.core.logic.fol.kb.data.Chain cont = new aima.core.logic.fol.kb.data.Chain(lits);
