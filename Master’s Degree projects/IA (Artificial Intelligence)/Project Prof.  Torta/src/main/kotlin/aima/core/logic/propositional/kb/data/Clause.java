 ...
 */
public class Clause {
	public static final aima.core.logic.propositional.kb.data.Clause EMPTY = new aima.core.logic.propositional.kb.data.Clause();
	//
	...
	public boolean equals(Object othObj) {
		...
		if (!(othObj instanceof aima.core.logic.propositional.kb.data.Clause)) {
			return false;
		}
		aima.core.logic.propositional.kb.data.Clause othClause = (aima.core.logic.propositional.kb.data.Clause) othObj;
