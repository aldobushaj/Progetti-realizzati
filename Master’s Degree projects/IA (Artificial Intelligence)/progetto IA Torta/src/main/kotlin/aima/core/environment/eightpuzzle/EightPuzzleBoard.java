...
public class EightPuzzleBoard implements Cloneable {
	...
	public boolean equals(Object o) {
		if (o != null && getClass() == o.getClass()) {
			aima.core.environment.eightpuzzle.EightPuzzleBoard aBoard = (aima.core.environment.eightpuzzle.EightPuzzleBoard) o;
	...
	@Override
	public aima.core.environment.eightpuzzle.EightPuzzleBoard clone() {
		aima.core.environment.eightpuzzle.EightPuzzleBoard result = null;
		try {
			result = (aima.core.environment.eightpuzzle.EightPuzzleBoard) super.clone();
