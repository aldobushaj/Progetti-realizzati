...
public class Variable implements Term {
	...
	public aima.core.logic.fol.parsing.ast.Variable copy() {
		return new aima.core.logic.fol.parsing.ast.Variable(value, indexical);
	}
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof aima.core.logic.fol.parsing.ast.Variable)) {
			return false;
		}

		aima.core.logic.fol.parsing.ast.Variable v = (aima.core.logic.fol.parsing.ast.Variable) o;
