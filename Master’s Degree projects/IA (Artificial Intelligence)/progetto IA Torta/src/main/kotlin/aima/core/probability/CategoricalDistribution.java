...
import aima.core.probability.ProbabilityMass;
...
public interface CategoricalDistribution extends ProbabilityMass {
	 ...
	 * 
	 * @see aima.core.probability.CategoricalDistribution#iterateOver(Iterator)
	 * @see aima.core.probability.CategoricalDistribution#iterateOver(Iterator,
	 ...
	 *
	 * @see aima.core.probability.CategoricalDistribution#setValue(int, double)
	 */
	double[] getValues();
	 ...
	 *
	 * @see aima.core.probability.CategoricalDistribution#getValues()
	 ...
	 *         values.
	 */
	aima.core.probability.CategoricalDistribution marginal(RandomVariable... vars);
	 ...
	 *             of the dividend.
	 */
	aima.core.probability.CategoricalDistribution divideBy(aima.core.probability.CategoricalDistribution divisor);
	 ...
	 *
	 * @see aima.core.probability.CategoricalDistribution#multiplyByPOS(aima.core.probability.CategoricalDistribution,
	 *      RandomVariable...)
	 */
	aima.core.probability.CategoricalDistribution multiplyBy(aima.core.probability.CategoricalDistribution multiplier);
	 ...
	 * 
	 * @see aima.core.probability.CategoricalDistribution#multiplyBy(aima.core.probability.CategoricalDistribution)
	 */
	aima.core.probability.CategoricalDistribution multiplyByPOS(aima.core.probability.CategoricalDistribution multiplier,
