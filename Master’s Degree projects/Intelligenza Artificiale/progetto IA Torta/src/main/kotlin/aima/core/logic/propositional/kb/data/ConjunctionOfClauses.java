...
public class ConjunctionOfClauses {
	 ...
	 */
	public aima.core.logic.propositional.kb.data.ConjunctionOfClauses extend(Collection<Clause> additionalClauses) {
		...
		aima.core.logic.propositional.kb.data.ConjunctionOfClauses result = new aima.core.logic.propositional.kb.data.ConjunctionOfClauses(extendedClauses);
	...
	public boolean equals(Object othObj) {
		...
		if (!(othObj instanceof aima.core.logic.propositional.kb.data.ConjunctionOfClauses)) {
			return false;
		}
		aima.core.logic.propositional.kb.data.ConjunctionOfClauses othConjunctionOfClauses = (aima.core.logic.propositional.kb.data.ConjunctionOfClauses) othObj;
