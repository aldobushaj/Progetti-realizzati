...
public class ArbitraryTokenDomain extends AbstractFiniteDomain {
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof aima.core.probability.domain.ArbitraryTokenDomain)) {
			return false;
		}

		aima.core.probability.domain.ArbitraryTokenDomain other = (aima.core.probability.domain.ArbitraryTokenDomain) o;
