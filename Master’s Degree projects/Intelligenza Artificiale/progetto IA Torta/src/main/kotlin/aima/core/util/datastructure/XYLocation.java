...
public class XYLocation {
	 ...
	 */
	public aima.core.util.datastructure.XYLocation west() {
		return new aima.core.util.datastructure.XYLocation(x - 1, y);
	}
	 ...
	 */
	public aima.core.util.datastructure.XYLocation east() {
		return new aima.core.util.datastructure.XYLocation(x + 1, y);
	}
	 ...
	 */
	public aima.core.util.datastructure.XYLocation north() {
		return new aima.core.util.datastructure.XYLocation(x, y - 1);
	}
	 ...
	 */
	public aima.core.util.datastructure.XYLocation south() {
		return new aima.core.util.datastructure.XYLocation(x, y + 1);
	}
	 ...
	 * @return the location one unit left of this location.
	 */
	public aima.core.util.datastructure.XYLocation left() {
		return west();
	}
	 ...
	 * @return the location one unit right of this location.
	 */
	public aima.core.util.datastructure.XYLocation right() {
		return east();
	}
	 ...
	 */
	public aima.core.util.datastructure.XYLocation up() {
		return north();
	}
	 ...
	 */
	public aima.core.util.datastructure.XYLocation down() {
		return south();
	}
	 ...
	 *         direction.
	 */
	public aima.core.util.datastructure.XYLocation locationAt(Direction direction) {
	...
	public boolean equals(Object o) {
		if (null != o && getClass() == o.getClass()) {
			aima.core.util.datastructure.XYLocation loc = (aima.core.util.datastructure.XYLocation) o;
