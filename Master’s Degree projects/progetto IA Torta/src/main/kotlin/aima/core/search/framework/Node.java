...
public class Node<S, A> {
	...
	private final aima.core.search.framework.Node<S, A> parent;
	 ...
	 */
	public Node(S state, aima.core.search.framework.Node<S, A> parent, A action, double pathCost) {
		this.state = state;
		this.parent = parent;
		this.action = action;
	 ...
	 */
	public aima.core.search.framework.Node<S, A> getParent() {
		return parent;
	}
