...
public class ConnectionHandler implements Runnable {
    ...
    String filePath = "C:\\Users\\silve\\Downloads\\Posta (3)\\";
    ...
    public void run() {
        ...
        String filePath = "C:\\Users\\silve\\Downloads\\Posta (3)\\Posta\\";
        ...
        try {
            ...
            if (inputObject instanceof Email) {//caso in cui si deve scrivere sul file l'email
                        ...
                        try {
                            ...
                            try {
                                for (String destiString : email.getDestinatario()) {
                                    ...
                                    destiString=destiString.replaceAll("[^A-Za-z0-9 ]", "");
                                   
                                    Path path = Paths.get((filePath + destiString + ".txt"));
                                    System.out.println("Il path ripulito è "+ path.toString());
                                    if (Files.exists(path)) {
                                        ...
                                        obj.setInfoServer("Destinatario inesistente!");
                ...
                try {
                    ...
                    obj.setInfoServer("Utente: "+ user + "ha eliminato "+ email_da_togliere.size()+ " emails");
